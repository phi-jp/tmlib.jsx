...
function _Main$main$AS(args) {
	...
	app.canvas.setSize$NN(ShootingApp.SCREEN_WIDTH, ShootingApp.SCREEN_HEIGHT);
...
function Random$randint$II(min, max) {
	return (Math.floor(Math.random() * (max - min + 1)) + min | 0);
};

Random.randint$II = Random$randint$II;

function Random$radfloat$NN(min, max) {
	return Math.random() * (max - min) + min;
};

Random.radfloat$NN = Random$radfloat$NN;

function Random$randbool$() {
	return Random$randint$II(0, 1) === 1;
};

Random.randbool$ = Random$randbool$;
...
function ShootingApp(elm) {
	...
	AssetManager$load$HSF$HXV$(({ "my": "http://rawgithub.com/phi-jp/tmlib.js/0.1.8/resource/img/shooting/player00.png", "rock": "http://rawgithub.com/phi-jp/tmlib.js/0.1.8/resource/img/shooting/enemy.png", "bullet": "http://rawgithub.com/jsx/JSX/master/web/example/shooting/img/bullet.png" }), (function (hoge) {
		var scene;
		scene = new GameScene();
...
function GameScene() {
	...
	this.scoreLabel.setPosition$NN(230, 20);
	this.scoreLabel.align = "right";
	this.addChild$LElement$0$(this.scoreLabel);
};
...
GameScene.prototype.update$X = function (app) {
	...
	baseApp = (function ($v) {
		if (! ($v == null || $v instanceof BaseApp)) {
			debugger;
			throw new Error("[examples/shooting/src/shootingapp.jsx:70:26] detected invalid cast, value is not an instance of the designated type or null\n        var baseApp = app as BaseApp;\n                          ^^\n");
		}
		return $v;
	}(app));
	...
	this.enemyGroup.children.some((function (enemy) {
		if ($this.player.isHit$LObject2D$((function ($v) {
			if (! ($v == null || $v instanceof Object2D)) {
				debugger;
				throw new Error("[examples/shooting/src/shootingapp.jsx:87:40] detected invalid cast, value is not an instance of the designated type or null\n            if (this.player.isHit(enemy as Object2D)) {\n                                        ^^\n");
			}
			return $v;
		}(enemy)))) {
			enemy.remove$();
		...
		$this.enemyGroup.children.some((function (enemyElement) {
			...
			enemy = (function ($v) {
				if (! ($v == null || $v instanceof Enemy)) {
					debugger;
					throw new Error("[examples/shooting/src/shootingapp.jsx:97:41] detected invalid cast, value is not an instance of the designated type or null\n                var enemy = enemyElement as Enemy;\n                                         ^^\n");
				}
				return $v;
			}(enemyElement));
			if ((function ($v) {
				if (! ($v == null || $v instanceof Object2D)) {
					debugger;
					throw new Error("[examples/shooting/src/shootingapp.jsx:98:29] detected invalid cast, value is not an instance of the designated type or null\n                if ( (bullet as Object2D).isHit( enemy as Object2D )) {\n                             ^^\n");
				}
				return $v;
...
Player.prototype.update$X = function (app) {
	...
	canvasapp = (function ($v) {
		if (! ($v == null || $v instanceof CanvasApp)) {
			debugger;
			throw new Error("[examples/shooting/src/shootingapp.jsx:132:28] detected invalid cast, value is not an instance of the designated type or null\n        var canvasapp = app as CanvasApp;\n                            ^^\n");
		}
		return $v;
	}(app));
	left = 0;
	...
	baseApp = (function ($v) {
		if (! ($v == null || $v instanceof BaseApp)) {
			debugger;
			throw new Error("[examples/shooting/src/shootingapp.jsx:147:26] detected invalid cast, value is not an instance of the designated type or null\n        var baseApp = app as BaseApp;\n                          ^^\n");
		}
		return $v;
	}(app));
	p = baseApp.pointing;
...
ShootingApp.SCREEN_WIDTH = 240;
ShootingApp.SCREEN_HEIGHT = 320;
$__jsx_lazy_init(ShootingApp, "SCREEN_CENTER_X", function () {
	return ShootingApp.SCREEN_WIDTH / 2;
});
$__jsx_lazy_init(ShootingApp, "SCREEN_CENTER_Y", function () {
	return ShootingApp.SCREEN_HEIGHT / 2;
});
